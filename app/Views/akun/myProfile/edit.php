  ...
  <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
    ...
    <div class="row gx-5 justify-content-center">
      <div class="col-lg-8 col-xl-6">
        <form action="/myProfile/update/<?= user()->id; ?>" method="post" enctype="multipart/form-data">
          ...
          <!-- NIK input-->
          <div class="form-floating mb-3">
            <input class="form-control <?= ($validation->hasError('nik')) ? 'is-invalid' : ''; ?>" id="nik" name="nik" type="number" placeholder="Masukan NIK" value="<?= (old('nik')) ? old('nik') : user()->nik; ?>" disabled />
          ...
          <!-- No KK input-->
          <div class="form-floating mb-3">
            <input class="form-control <?= ($validation->hasError('no_kk')) ? 'is-invalid' : ''; ?>" id="no_kk" name="no_kk" type="number" placeholder="Masukan No KK" value="<?= (old('no_kk')) ? old('no_kk') : user()->no_kk; ?>" disabled />
          ...
          <!-- Nama input-->
          <div class="form-floating mb-3">
            <input class="form-control <?= ($validation->hasError('fullname')) ? 'is-invalid' : ''; ?>" id="fullname" name="fullname" type="text" placeholder="Masukan Nama Lengkap" value="<?= (old('fullname')) ? old('fullname') : user()->fullname; ?>" disabled />
          ...
          <!-- Tanggal Lahir input-->
          <div class="form-floating mb-3">
            <input class="form-control <?= ($validation->hasError('tanggal_lahir')) ? 'is-invalid' : ''; ?>" id="tanggal_lahir" name="tanggal_lahir" type="date" placeholder="Masukan Tanggal Lahir" value="<?= (old('tanggal_lahir')) ? old('tanggal_lahir') : user()->tanggal_lahir; ?>" disabled />
          ...
          <!-- Nama Ibu input-->
          <div class="form-floating mb-3">
            <input class="form-control <?= ($validation->hasError('nama_ibu')) ? 'is-invalid' : ''; ?>" id="nama_ibu" name="nama_ibu" type="text" placeholder="Masukan Nama Ibu" value="<?= (old('nama_ibu')) ? old('nama_ibu') : user()->nama_ibu; ?>" autocomplete="off" disabled />
